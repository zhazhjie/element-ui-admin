...
<template>
  <section>
    ...
    <div style="margin-bottom: 15px;">
      <permission-btn permission='sys:menu:add' type='primary' @click='handleAdd'>新增</permission-btn>
    </div>
    ...
    <el-dialog
      ...
      <el-form :model="curMenu" label-width="80px" :rules="rules" ref="ruleForm">
        ...
        <!-- <el-form-item label='菜单路径' :prop='curMenu.type<2?"url":""' v-show='curMenu.type<2'>
  ...
  export default {
    ...
    methods: {
      ...
      handleChange(row) {
        ...
        this.dialogVisible = true;
        this.$nextTick(el=>{
          for (let key in this.curMenu) {
            this.curMenu[key] = row[key];
          }
          if(!this.curMenu.parentName){
            this.curMenu.parentName = "一级菜单";
          }
        });
      },
      ...
      handleNodeClick(data) {
        this.curMenu.parentId = data.id;
        this.curMenu.parentName = data.name;
      },
      handleClose(done) {
        this.dialogVisible = false;
